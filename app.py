...
def get_top_300_coins():
    ...
    try:
        ...
        fallback = ["BTC","ETH","SOL","BNB","XRP","DOGE","ADA","TRX","LINK","AVAX","TON","SHIB","DOT","LTC","BCH","NEAR","APT","MATIC","ARB","OP","SUI","PEPE","WIF","BONK","SEI","TIA","INJ","FET","RNDR","TAO","WLD","PYTH","JUP"]
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .arb-header { font-weight: bold; color: #667eea; border-bottom: 2px solid #667eea; margin-bottom: 8px; font-size: 0.75em; }
        ...
        .debug { background: #2a2f4f; padding: 10px; border-radius: 5px; margin: 10px 0; font-size: 0.65em; font-family: monospace; word-break: break-all; }
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>5 Exchanges | 300 Coins | Real-time Arbitrage Scanner</p>
        </div>
        ...
        <footer>
            ...
            <br>Auto-refreshes every 20 seconds
        </footer>
    </div>
...
if __name__ == "__main__":
    ...
    print("="*70)
    print("🚀 Arbimine.pro - Enhanced Arbitrage Scanner")
    print("="*70)
